...
# ==============================================================================
# BLOCKLIST UPDATER v1.3.3
# Features: Multi-Source, Deduplication, Persistent Stats, FW Hook
# Change Log: v1.3.3 - Calculates and saves VPN List Diff for dashboard
# ==============================================================================
...
# 4. DEEP DEDUPLICATION (VPN) AND STATS
...
if ipset list -n "$IPSET_VPN" >/dev/null 2>&1; then
    ...
    if [ "$CLEAN_COUNT" -gt 0 ]; then
        ...
        # Even if no change, update the file timestamp/value
